...
const temples = [
    ...
    {
        templeName: "Brazília Brazil Temple",
    ...
    },
    {
        ...
        area: 10700,
        imageUrl: "https://churchofjesuschristtemples.org/assets/img/temples/fukuoka-japan-temple/fukuoka-japan-temple-46766.jpg"
    },
    {
        templeName: "Ciudad Juárez Mexico Temple",
        location: "Ciudad Juárez Mexico",
        dedicated: "2000, Febuary, 26-27",
        area: 10700,
    ...
    },
    {
        ...
        location: "Bentonville Arkansas, Unites States",
        dedicated: "2023, September, 17",
        area: 28472,
...
const temple1 = document.getElementById("temple");

temples.forEach(temple => {
    const div = document.createElement("div");
    div.innerHTML = `
    <h1>${temple.templeName}</h1>
    <p class="temple-name"> Location: ${temple.location}</p>
    <p> Dedicated: ${temple.dedicated}</p>
    <p> Area: ${temple.area}</p>
    <img class="temple-img" src="${temple.imageUrl}" alt="Lds temple image" loading="lazy" width="300" height="250">
    `;

    temple1.appendChild(div);
});
